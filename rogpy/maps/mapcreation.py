...
class dMap:
    ...
    def get_entry(self):
        ...
        while test == False:
            ...
            height, width, startx, starty = room
            print (room)
            x = randrange(startx, startx + width)
            y = randrange(starty, starty + height)
            # test = self.test_empty(x, y)
            test = True
        #self.mapArr[y][x] = 6
    ...
    def print_map(self):
        for y in range(len(self.mapArr)):
            line = ""
            for x in range(len(self.mapArr[y])):
                if self.mapArr[y][x]==0:
                    line += "."
                ...
                if self.mapArr[y][x]==2:
                    line += "#"
                if self.mapArr[y][x]==3 or self.mapArr[y][x]==4:
                    line += "="
                if self.mapArr[y][x]==5:
                    line += "+"
                if self.mapArr[y][x]==6:
                    line += "@"
            print(line)
...
if __name__ == "__main__":
    ...
    themap= dMap()
    themap.makeMap(startx,starty,110,50,3) 
    ...
    # for y in range(starty):
            ...
            # for x in range(startx):
                    ...
                    # if themap.mapArr[y][x]==2:
                        # line += "#"
                    # if themap.mapArr[y][x]==3 or themap.mapArr[y][x]==4:
                        # line += "="
                    # if themap.mapArr[y][x]==5:
                        # line += "+"
